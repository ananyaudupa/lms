...
export const roleBasedCourses: CourseItem[] = [
  ...
  { title: 'Data Engineer',   description: 'Build scalable data pipelines and architectures to collect, process, and deliver reliable data for analytics and AI.', image: 'https://images.unsplash.com/photo-1518186285589-2f7649de83e0?w=400&h=220&fit=crop' },
