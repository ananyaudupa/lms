  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
        <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#2563eb', boxShadow: '0 0 6px rgba(37,99,235,0.5)' }} />
        <span style={{ color: '#64748b', fontSize: 11, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase' }}>Node Moved</span>
      </div>
      <div style={{ color: '#1e3a8a', fontSize: 13, fontWeight: 600, marginBottom: 8 }}>{nodeLabel}</div>
